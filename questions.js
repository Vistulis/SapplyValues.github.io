questions =  [
    ...
    {"id": 46, "question": "A universal basic income is a viable solution to address economic inequality.", "effects": {"right": -1}},
    {"id": 47, "question": "Government intervention is necessary to protect the environment.", "effects": {"right": -1}},
    {"id": 48, "question": "Private property is a fundamental right and essential for individual liberty.", "effects": {"right": 1}},
    {"id": 49, "question": "Education should be free and accessible to everyone.", "effects": {"right": -1}},
    {"id": 50, "question": "The market should determine the value of goods and services, without government interference.", "effects": {"right": 1}},
    {"id": 51, "question": "Corporations should pay higher taxes to fund public services.", "effects": {"right": -1}},
    {"id": 52, "question": "The government should regulate and control monopolies to ensure fair competition.", "effects": {"right": -1}},
    {"id": 53, "question": "Immigration restrictions are necessary to protect jobs and national identity.", "effects": {"right": 1}},
    {"id": 54, "question": "Universal healthcare is a basic human right.", "effects": {"right": -1}},
    {"id": 55, "question": "Social safety nets, like unemployment benefits, are essential for a just society.", "effects": {"right": -1}},
    {"id": 56, "question": "Government spending should be reduced to allow for lower taxes.", "effects": {"right": 1}},
    {"id": 57, "question": "Individuals should have the right to own firearms for self-defense.", "effects": {"right": 1}},
    {"id": 58, "question": "Strict environmental regulations hinder economic growth.", "effects": {"right": 1}},
    {"id": 59, "question": "Economic globalization benefits everyone in the long run.", "effects": {"right": 1}},
    {"id": 60, "question": "Affirmative action is necessary to address historical and systemic discrimination.", "effects": {"right": -1}},
    {"id": 61, "question": "Euthanasia should be legally permitted under certain circumstances.", "effects": {"prog": 1}},
    {"id": 62, "question": "Genetic modification of crops is essential to address global food shortages.", "effects": {"prog": 1}},
    {"id": 63, "question": "Marijuana should be legalized for recreational use.", "effects": {"prog": 1}},
    {"id": 64, "question": "Government surveillance is a necessary trade-off for national security.", "effects": {"auth": 1}},
    {"id": 65, "question": "The concept of borders is outdated and should be eliminated.", "effects": {"right": -1}},
    {"id": 66, "question": "Artificial intelligence should be regulated to prevent job loss and ethical issues.", "effects": {"prog": -1}},
    {"id": 67, "question": "The government should provide free higher education to all citizens.", "effects": {"right": -1}},
    {"id": 68, "question": "Prisons should focus on rehabilitation rather than punishment.", "effects": {"prog": -1}},
    {"id": 69, "question": "Government censorship is necessary to protect societal morals.", "effects": {"auth": 1}},
    {"id": 70, "question": "Individuals should have the right to die through assisted suicide.", "effects": {"prog": 1}}
];
